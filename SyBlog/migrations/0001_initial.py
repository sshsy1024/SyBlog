# Generated by Django 2.2.7 on 2019-11-18 13:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='SyBlog.Category', verbose_name='分类')),
                ('recommend', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='SyBlog.Recommend', verbose_name='推荐位')),
                ('tags', models.ManyToManyField(blank=True, to='SyBlog.Tag', verbose_name='标签')),
